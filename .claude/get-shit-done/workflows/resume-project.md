...
<required_reading>
@C:/Users/User/Documents/rent-contract-bot/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "C:/Users/User/Documents/rent-contract-bot/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
