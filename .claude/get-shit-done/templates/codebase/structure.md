...
- Usage: Reference from command with `@C:/Users/User/Documents/rent-contract-bot/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/User/Documents/rent-contract-bot/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/User/Documents/rent-contract-bot/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
